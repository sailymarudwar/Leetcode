...
Assume we are dealing with an environment which could only store integers within the 32-bit signed integer range: [−231,  231 − 1]. If the numerical value is out of the
...
s = Solution()
print(s.myAtoi("In -4192 in words"))